...
| **Network analytics** | Live per-interface throughput (streaming chart), vnStat bandwidth history (14-day bars), protocol distribution, top processes by socket activity, and DNS resolver stats — daemon-light, built on /proc, ss and vnStat |
